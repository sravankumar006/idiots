...
import {
  ...
  Maximize2, Sparkles, BookOpen, Heart, CheckCircle2, Send, ArrowRight, RefreshCw
} from 'lucide-react'
    ...
    const fetchRepoSync = async () => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          setSyncError(data.error || 'Failed to sync project details')
        }
      } catch (err) {
        console.error("Repo sync fetch failed", err)
        setSyncError('GitHub API unavailable')
      } finally {
